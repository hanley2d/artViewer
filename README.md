...
- <p><a href="https://github.com/hanley2d/artViewer/blob/master/view/components/colors.js">components/colors.js</a></p> Used to define the custom colours used for the application.
