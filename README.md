...
| <p><a href="https://github.com/hanley2d/artViewer/blob/master/view/components/colors.js">view/components/colors.js</a></p> | Used to define the custom colours used for the application. The colours are meant to be subtle and non-imposing so as not to draw attention away from the artwork. Kind of like an art museum. |
| <p><a href="https://github.com/hanley2d/artViewer/blob/master/view/components/ListItem.js">view/components/ListItem.js</a></p> | Defines a custom card component that is used to display the items in the flatlists of ArtSearch.js and BrowseCollections.js |
| <p><a href="https://github.com/hanley2d/artViewer/blob/master/view/components/RandomButton.js">view/components/RandomButton.js</a></p> | Custom pressable with an opacity effect added for when it is pressed. |
| <p><a href="https://github.com/hanley2d/artViewer/blob/master/view/components/ScrollViewButton.js">view/components/ScrollViewButton.js</a></p> | Custom pressable with an opacity effect added for when it is pressed. It is designed to be used within a horizontal scrollview so users can scroll through multiple category buttons. |
